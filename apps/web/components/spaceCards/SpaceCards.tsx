...
const SpaceCards = ({ title, description }: SpaceCardsPropTypes) => {
  return (
    <Card className="overflow-hidden rounded-lg shadow-md transition-all hover:scale-[1.02] hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary w-[293px]">
      <Image
        src=""
        alt="Project 1"
        width={600}
